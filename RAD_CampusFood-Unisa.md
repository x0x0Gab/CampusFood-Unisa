...
In questa prima versione (Release 1) sono previste le seguenti funzionalità:
- visualizzazione del menù giornaliero
- visualizzazione del menù settimanale
- consultazione degli orari di apertura e chiusura
- visualizzazione indicativa della disponibilità posti (dati simulati)
...
_(Gli attori Gestore Mensa e Amministratore di Sistema verranno introdotti nelle release successive.)_
...
| RF5 | Visualizzare indicazioni sulla disponibilità posti (anche simulate) | Media |
...
| Post-condizioni | Menù giornaliero visualizzato |

**Scenario principale**
1. Lo studente accede al sito
2. Seleziona la voce “Menù del giorno”
3. Il sistema recupera i dati del menù (simulati)
4. Il sistema mostra il menù del giorno

**Estensioni**
- 3a. Dati non disponibili → visualizzazione di un messaggio informativo

_(UC2 e UC3 saranno descritti in modo analogo nelle versioni successive del documento.)_

---

### 3.5.2 Modello a oggetti
Il modello a oggetti verrà definito nelle successive versioni del RAD, introducendo concetti quali Menù, Giorno e Piatto.

### 3.5.3 Modello dinamico
I diagrammi di sequenza relativi ai casi d’uso saranno sviluppati nelle release successive.

### 3.5.4 Interfaccia utente e navigazione
Mockup e descrizione dettagliata dell’interfaccia utente saranno forniti nelle versioni successive del documento.
