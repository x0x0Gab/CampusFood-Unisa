...
La versione 0.3 estende la RAD v0.2 includendo i **mockup UI** (desktop e mobile) della Release 1.

Per evitare che gli screen mockup **mobile** (verticali e molto lunghi) occupino tutta la documentazione, nel documento sono riportati:

- link diretti alle immagini
- anteprime racchiuse in sezioni collassabili ("details")
...
## 5. Mockup di presentazione UI (Release 1)

Questa sezione raccoglie i mockup prodotti per la presentazione dell’interfaccia **responsive**.

Cartella sorgente: `img/mockup-ui/`

> Nota: i mockup mobile sono volutamente inseriti come link e anteprime collassabili.

### 5.1 Home

- Desktop: ![Mockup Home - Desktop](img/mockup-ui/01-home-desktop.png)
- Mobile (link, schermata lunga): [Home Mobile](img/mockup-ui/01-home-mobile.png)

---

### 5.2 Menù del giorno

- Desktop: ![Mockup Menù del giorno - Desktop](img/mockup-ui/02-menu-giorno-desktop.png)
- Mobile (link, schermata lunga): [Menù del giorno Mobile](img/mockup-ui/02-menu-giorno-mobile.png)

---

### 5.3 Menù settimanale

- Desktop: ![Mockup Menù settimanale - Desktop](img/mockup-ui/03-menu-settimanale-desktop.png)
- Mobile (link, schermata lunga): [Menù settimanale Mobile](img/mockup-ui/03-menu-settimanale-mobile.png)

---

### 5.4 Informazioni mensa

- Desktop: ![Mockup Informazioni mensa - Desktop](img/mockup-ui/04-info-mensa-desktop.png)
- Mobile (link, schermata lunga): [Informazioni mensa Mobile](img/mockup-ui/04-info-mensa-mobile.png)

---

## 6. Criteri di accettazione Release 1
